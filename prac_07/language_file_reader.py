...
# Namedtuple is a subclass of the built-in tuple that
# allows you to create tuple-like objects with named fields,
# making your code more readable and self-documenting.
...
def using_namedtuple():
    ...
    # namedtuple allows you to create tuple subclasses with name
    # It can access the value in a give named tuple using the dot
    ...
    for row in reader:
        # print(row)
        # _make()method used to convert an iterable object like
